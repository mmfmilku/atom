...
public class UseImportsTest {
    ...
    @Test
    public void useImportsTest() throws IOException {
        String s = FileUtils.readText(System.getProperty("user.dir") + "\\src\\test\\java\\org\\mmfmilku\\atom\\agent\\compiler\\parser\\UseImportsTest.java");
